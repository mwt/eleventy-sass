let areAllPathsUnixCompatible = false;
try {
  require("@11ty/eleventy/src/Util/PathNormalizer");
  areAllPathsUnixCompatible = true;
} catch { }
...
const fileURLToPath = areAllPathsUnixCompatible ? fileURL => path.posix.relative(".", url.fileURLToPath(fileURL))
